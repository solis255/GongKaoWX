...
最近一次本地验证结果（2026-09-16）：

- 104 项测试全部通过
- 2～4 个连续选项的 Schema、导入校验、动态渲染、判题、指纹及存储导出往返均通过验证
